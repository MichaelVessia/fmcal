...
// Root command - show help hint when no subcommand provided
const fmcal = Command.make("fmcal", {}, () =>
  Console.log("Run 'fmcal --help' for usage information."),
).pipe(
...
// Run
Effect.suspend(() => cli(process.argv)).pipe(Effect.provide(MainLayer), BunRuntime.runMain);
